...
public class AccountResponse {
   ...
   */
  public AccountResponse(String id, String customerId, AccountType type, String currency, Float balance, StatusEnum status) {
    this.id = id;
  ...
  */
  ...
  public AccountResponse balance(Float balance) {
    this.balance = balance;
    return this;
  }
  ...
  */
  ...
  public AccountResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, customerId, type, currency, balance, status);
  }
